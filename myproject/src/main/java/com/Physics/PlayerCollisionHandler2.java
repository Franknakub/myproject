...
public class PlayerCollisionHandler2 extends CollisionHandler{

    PlayerType playerType;
    SceneType sceneType;

    public PlayerCollisionHandler2(PlayerType playerType, SceneType sceneType) {
    ...
    protected void onCollisionBegin(Entity player, Entity scene) {
       ...
       SystemEvent.eventBus.fireEvent(new NextScene(NextScene.SCENE2TO1));
