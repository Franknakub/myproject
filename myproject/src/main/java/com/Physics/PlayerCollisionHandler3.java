...
public class PlayerCollisionHandler3 extends CollisionHandler{

    PlayerType playerType;
    SceneType sceneType;

    public PlayerCollisionHandler3(PlayerType playerType, SceneType sceneType) {
    ...
    protected void onCollisionBegin(Entity player, Entity scene) {
       ...
       SystemEvent.eventBus.fireEvent(new NextScene(NextScene.SCENE2TO3));
