     ...
     public Entity setenemy1(SpawnData data) {
         ...
         physics.setBodyType(BodyType.STATIC);
          ...
          return FXGL.entityBuilder(data)
                 ...
                 .with(new StatusComponent("Knight Michael", "HB","",250, 50, 100, 100))
     ...
     public Entity setenemy2(SpawnData data) {
         ...
         physics.setBodyType(BodyType.STATIC);
          ...
          return FXGL.entityBuilder(data)
                 ...
                 .with(new StatusComponent("Empress Duessa", "HB","",500, 50, 100, 100))
                 .with(new DamageEnemyComponent(20))
                 .with(physics)
                 //.bbox(new HitBox(BoundingShape.box(64,64)))
                 //.at(0,100)
     ...
     public Entity setenemy3(SpawnData data) {
         ...
         physics.setBodyType(BodyType.STATIC);
          ...
          return FXGL.entityBuilder(data)
                 ...
                 .with(new StatusComponent("King Archial", "HB","",500, 50, 100, 100))
                 .with(new DamageEnemyComponent(20))
                 .with(physics)
                 .build();
