...
public class PlayerComponent extends Component {
    ...
    public PlayerComponent(double x, double y) {
        this.x = x;
        this.y = y;
        left = new AnimationChannel(FXGL.image("J.png"), Duration.seconds(0.5), 6);
        right = new AnimationChannel(FXGL.image("J.png"), Duration.seconds(0.5), 6);
        upDown = new AnimationChannel(FXGL.image("J.png"), Duration.seconds(0.5), 6);
